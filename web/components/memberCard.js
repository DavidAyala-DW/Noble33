...
export default function MemberCard({member}) {
  ...
  return (
    ...
    <div className="w-full aspect-h-1 aspect-w-[.96] md:aspect-w-[.803] lg:aspect-w-[.7727] 3xl:aspect-w-[1.033] relative">
      ...
      md:space-y-[2px] vw:space-y-[.104vw] justify-end pb-7 pl-[14px] md:pb-5 vw:pb-[1.0416vw] md:pl-5 vw:pl-[1.0416vw] z-[2]"
      >
