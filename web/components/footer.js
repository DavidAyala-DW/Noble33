...
export default function Footer(props) {
  ...
  return (
    ...
    <footer className="px-4 md:px-0 pb-[32px] md:pb-12 md2:pb-[50px] vw:pb-[2.60vw] md:max-w-[93.3%] w-full md:mx-auto flex flex-col md2:flex-row items-start">

      <div className="mb-[42px] md2:mb-0 md2:mr-[5.8%] 3xl:mr-[28.645vw] w-max">

        <Link href="/" passHref>

          <a className="block w-[86px] md:w-[153px] vw:w-[7.968vw]">
            <Image
              src={Logo}
              alt="Logo"
              layout="responsive"
      ...
      <div className="flex flex-col space-y-16 md2:space-y-[110px] vw:space-y-[5.729vw] justify-between w-full">
        ...
        <div className="flex flex-col space-y-6 md:space-y-8 md2:space-y-8 vw:space-y-[1.666vw]">
          ...
          <form className="w-full md:max-w-[78.8%] md2:max-w-full" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col space-y-12 md2:space-y-0 md2:flex-row md2:items-center justify-between">
          ...
          <div className="flex items-center space-x-6 vw:space-x-[1.25vw]">
            ...
            <a href={facebookHandle} className="block w-6 vw:w-[1.25vw]">
            ...
            <a href={instagramHandle} className="block w-6 vw:w-[1.25vw]">
