...
export default function Details(props) {
  ...
  return (
    ...
    <section className="px-4 md:px-0 md:max-w-[93.3%] w-full mx-auto flex flex-col">
      ...
      <div className="flex flex-col space-y-[60px] md:space-y-0 md:flex-row items-start md:justify-between w-full mb-12 md:mb-[136px] vw:mb-[9.444vw]">

        <div className="flex flex-col md:max-w-[calc(50%-48px)] vw:max-w-[calc(50%-3.333vw)]">
          ...
          <p className="tracking-[.05em] text-lg vw:text-[1.25vw] leading-[21px] vw:leading-[1.1666] opacity-80 font-light md:max-w-[400px] vw:max-w-[27.77vw]">
            {description}
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-y-12 md:gap-x-6 md:gap-y-[148px] vw:gap-x-[1.666vw] vw:gap-y-[10.277vw]">
