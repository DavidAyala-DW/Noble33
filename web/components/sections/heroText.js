...
export default function HeroText(props) {
  ...
  return (
    ...
    <section className='px-4 md:px-0 pt-[120px] md:pt-[208px] vw:pt-[10.8333vw] pb-[120px] md:pb-[122px] vw:pb-[6.354vw] md:max-w-[93.3%] w-full mx-auto flex flex-col justify-center' id="mainHero">
