        ...
        <section
          ...
          >   
            ...
            <div className="flex flex-col mb-12 md:mb-[38px] vw:mb-[1.979vw]">
              ...
              <a className="mt-8 vw:mt-[1.6666vw] flex items-center space-x-1.5 max-w-max tracking-[.05em] uppercase text-xs vw:text-[.625vw] leading-[1.1] font-light" href={link.url}>
